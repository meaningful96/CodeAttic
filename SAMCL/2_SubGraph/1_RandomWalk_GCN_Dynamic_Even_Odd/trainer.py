...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        self.train_num_candidates = self.step_size * (self.batch_size//2) //(self.subgraph_size*2) 
        self.valid_num_candidates = self.valid_step_size * (self.batch_size//2) // (args.subgraph_size*2)
