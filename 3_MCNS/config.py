...
parser.add_argument('--walks-num', default=100, type=int, metavar='N',
                    help = 'dfs path length')
parser.add_argument('--valid-walks-num', default=100, type=int, metavar='N',
                    help = 'dfs path length on validation set')
parser.add_argument('--N-negs', default=1, type=int, metavar='N',
                    help = 'number of negatives per positive')
parser.add_argument('--N-steps', default=10, type=int, metavar='N',
                    help='burn in period during MCMC')
...
parser.add_argument('--is-train', default='train', type=str,
                    help = '--for log file naming')
