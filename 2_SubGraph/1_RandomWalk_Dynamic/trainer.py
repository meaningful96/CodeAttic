...
from randomwalk import RandomWalk, build_graph, Path_Dictionary
...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        train_data_dict = Path_Dictionary(args.train_path, self.k_steps, self.num_iter, train_obj)
        valid_data_dict = Path_Dictionary(args.valid_path, self.k_steps, self.num_iter, valid_obj)
