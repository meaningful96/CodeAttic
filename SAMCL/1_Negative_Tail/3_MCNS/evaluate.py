...
from doc import load_test_data, Example
...
def eval_single_direction(predictor: BertPredictor,
                          ...
                          batch_size=256) -> dict:
    start_time = time()
    examples = load_test_data(args.valid_path, add_forward_triplet=eval_forward, add_backward_triplet=not eval_forward)
