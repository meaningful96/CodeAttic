...
path = '/home/youminkk/Model_Experiment/2_SubGraph/7_BFS/data/WN18RR/train_bfs.pkl'
batch_size = 1024
subgraph = 512
step_size = 169
Epoch = 50

train_path = '/home/youminkk/Model_Experiment/2_SubGraph/7_BFS/data/WN18RR/train.txt.json'
obj = BFS(train_path)
...
logger.info("Done!!")
output_path = '/home/youminkk/wn_bfs.pkl'
