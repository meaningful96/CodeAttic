...
## added by youmin
parser.add_argument('--linkGraph-path', default='', type=str, metavar='N',
                    help='path to build linkGraph')
parser.add_argument('--negative-size', default=64, type=int, metavar='N',
                    help='negative size')
...
parser.add_argument('--tt', default=0.033, type=float,
                    help='temperature parameter')

parser.add_argument('--use-link-graph', action='store_true',
                    help='use neighbors from link graph as context')
parser.add_argument('--eval-every-n-step', default=1000000, type=int,
...
parser.add_argument('--num-step', default=5, type=int,
                    help='Random walk step size')
parser.add_argument('--iteration', default=200, type=int,
                    help='The number of random walk iterations')
