...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        train_obj, valid_obj = BFS(args.train_path), BFS(args.valid_path)
    ...
    def train_loop(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if epoch == 0:
                ...
                train_data, counted_appearance_train, sub_total, batch_total  = Making_Subgraph(self.train_diGraph,
                ...
                valid_data, counted_appearance_valid, _, _  = Making_Subgraph(self.valid_diGraph, 
